...
def elapsed_time_in_minutes(number_by_layers, elapsed_bake_time):
    """Calculate the elapsed cooking time.

    :param number_by_layers: int - the number by layers in the lasagna.
    ...
    lasagna.
    """
    return preparation_time_in_minutes(number_by_layers) + elapsed_bake_time